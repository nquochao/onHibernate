 ...
 * 
 */
public class HibernateJoinTableTest extends TestCase {
	private static final Logger log = LoggerFactory.getLogger(HibernateJoinTableTest.class);
	...
	public static void testOneToOneNotCommitted() {
		...
		JoinTableChessBoardPreference preference = new JoinTableChessBoardPreference();
		preference.setChesswidth(80);

// Add new username object
		JoinTableUserName userName = new JoinTableUserName();
