...
@Entity
public class SharedKeyChessBoardPreference {
	@Id
    @GeneratedValue
	Integer id;

	@OneToOne	(mappedBy = "preference")
	private SharedKeyUserName userName;
/**
...
public void setId(Integer id) {
	...
	public SharedKeyUserName getUserName() {
		return userName;
	}

	public void setUserName(SharedKeyUserName userName) {
