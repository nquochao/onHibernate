...
import oliviaproject.hibernate.foreignkey.ForeignKeyChessBoardPreference;
 ...
 * 
 */
public class HibernateForeignKeyTest extends TestCase {
	private static final Logger log = LoggerFactory.getLogger(HibernateForeignKeyTest.class);
	...
	public static void testOneToOneNotCommitted() {
		...
		ForeignKeyChessBoardPreference preference = new ForeignKeyChessBoardPreference();
		preference.setChesswidth(80);

// Add new username object
		ForeignKeyUserName userName = new ForeignKeyUserName();
